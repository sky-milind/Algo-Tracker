...
INSERT INTO `admin` (`full_name`, `username`, `email`, `password`, `role`, `status`, `created_by`) 
VALUES 
('Admin One', 'admin1', 'admin1@example.com', 'admin123', 'admin', 1, 1),
('Admin Two', 'admin2', 'admin2@example.com', 'admin123', 'admin', 1, 1);
